...
const Call = (props) => {
    ...
    useEffect(() => {
        ...
        return () => dispatch(resetCommunicationPartnerUser());
    }, []);
    ...
    return (
        <div className={classes.container}>
            ...
            <div className={classes.partnerVideoContainer}>
                <video className={classes.partnerVideo} ref={partnerVideo} autoPlay/>
            </div>
            ...
            <div className={classes.controlsContainer}>
                ...
                <FontAwesomeIcon icon={faPhoneSlash} size='1x' className={classes.icons}/>
            </div>
